...
public class WriteNoteBookInFile implements Command {
    @Override
    public Response execute(Request request) throws CommandException, IOException, ServiceException, ClassNotFoundException {
        ...
        try {
            nbService.writeNotebookInFile(req.getPath());
